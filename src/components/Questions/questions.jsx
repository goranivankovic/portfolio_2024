...
<div style={{background:bgColor}} id='about' className={questStyles.main}>
                     
         <div className={questStyles.fourDiv}style={{color:textColor}}>


                       {/* First Qustion */}
                     <div className={questStyles.fourDivItems}  style={{color:textColor,boxShadow:'2px 1px 10px',textColor}}>
   ...
   {/* Five Qustion */}
        ...
        <div className={questStyles.fiveDiv} style={{color:textColor}}>
          
            {/* Item1 */}
             <div className={questStyles.fiveDivItems} style={{color:textColor}}>
